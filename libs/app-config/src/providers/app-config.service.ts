...
export class AppConfigService {
	...
	/**
	 * Retrieves the REST API application configuration.
	 *
	 * @returns {AppConfig} The REST API application configuration object.
	 */
	get restApiAppConfig(): RestApiAppConfig {
		return this.config.get<RestApiAppConfig>("restApiAppConfig")!;
	}
	...
	/**
	 * Retrieves the AMQP configuration settings.
	 *
