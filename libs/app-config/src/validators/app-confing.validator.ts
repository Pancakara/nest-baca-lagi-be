...
import { MultipartConfigEnvironmentVariables } from "../configs/multipart.config";
import { RedisConfigEnvironmentVariables } from "../configs/redis.config";
import { RestApiAppConfigEnvironmentVariables } from "../configs/rest-api-app.config";
...
class EnvironmentVariables extends IntersectionType(
	...
	MultipartConfigEnvironmentVariables,
	RedisConfigEnvironmentVariables,
	RestApiAppConfigEnvironmentVariables,
