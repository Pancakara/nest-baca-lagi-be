 ...
 * - `shadowUrl`: An optional shadow database URL, typically used for testing or migrations, derived from the `SHADOW_DATABASE_URL` environment variable.
 ...
 * @property {string | undefined} SHADOW_DATABASE_URL - An optional shadow database URL, typically used for testing or migrations.
 */
